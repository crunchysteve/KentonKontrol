DO NOT #INCLUDE THIS FILE IN THE KentonKontrol.ino PROGRAM FILE
(The .h extension is for Arduino IDE project compatibility, only!)

KentonKontrol v1.0

KentonKontrol is a third-party MIDI Sysex tool for the Kenton D-Link MIDI DinSync interface. 
See:- kentonuk.com/product/d-sync/
...
Australia, where copyright law does not allow my to waive my moral copyright, I remain 
the owner of this work insofar as the components created by me are concerned, other moral 
